# -*- coding: utf-8 -*-
#
# django-pgpubsub documentation build configuration file, created by
...
htmlhelp_basename = 'django-pgpubsubdoc'
...
latex_documents = [
    (
        master_doc,
        'django-pgpubsub.tex',
        u'django-pgpubsub Documentation',
        u'Opus 10',
        'manual',
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        'django-pgpubsub',
        'Djagno integration with Postgres LISTEN and NOTIFY',
        'Miscellaneous',
    )
]
